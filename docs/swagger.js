      ...
      schemas: {
        ...
        MealLogEntry: {
          ...
          properties: {
            ...
            date: { type: 'string', example: '2024-11-19' },
            portion: { type: 'number' },
            note: { type: 'string' },
            caloriesOverride: { type: 'number' },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        },
        ...
        MealLogByDate: {
          type: 'object',
          properties: {
            breakfast: { type: 'array', items: { $ref: '#/components/schemas/MealLogEntry' } },
            lunch: { type: 'array', items: { $ref: '#/components/schemas/MealLogEntry' } },
            dinner: { type: 'array', items: { $ref: '#/components/schemas/MealLogEntry' } },
          },
